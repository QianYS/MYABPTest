...
using My.Project.Configuration.Ui;
using My.Project.Sessions;
using My.Project.WebMpa.Models;
using My.Project.WebMpa.Models.Layout;

namespace My.Project.WebMpa.Controllers
{
    public class LayoutController : ProjectControllerBase
    {
