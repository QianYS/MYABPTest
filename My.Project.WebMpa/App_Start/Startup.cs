...
﻿using Abp.Owin;
using My.Project.Api.Controllers;
using My.Project.WebMpa;
...
namespace My.Project.WebMpa
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in ProjectWebModule)
